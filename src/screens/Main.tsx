...
import { Box, Button, Container, Heading, Image, List, ListItem, Link, useColorModeValue, Icon } from '@chakra-ui/react';
		...
		<Box h="100vh">
			<Container maxW="container.md" pt={14}>
				...
				<Section delay={0.1} >
					...
					<Paragraph>
						한글입술으로 테스트.넣는 뭇 가슴에 것이다. 사는가 우리는 살 풀이 찾아 듣는다. 
						같이, 청춘은 넣는 속잎나고, 따뜻한 봄바람을 충분히 모래뿐일 것이다. 
						불어 인생에 보이는 간에 희망의 인류의 것이다. 열락의 착목한는 어디 맺어, 
						하였으며, 황금시대다.
						기술스택, 영어, 취미 등등 적기.
					</Paragraph>
						...
						<ListItem>
							<Link to='#'  >
								<Button
									...
									ml={9}
									onClick={() => window.location.href = 'mailto:discegaudere24.7@gmail.com'}
